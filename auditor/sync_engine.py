...
def init_db():
    """
    Create the local audit history database.
    """
...
def is_connected():
    """
    Check whether the system can reach the internet.
    """
...
def reconcile_pending_audits():
    """
    Mark pending audits as synced when
